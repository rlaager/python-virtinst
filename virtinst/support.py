...
_support_dict = {
    ...
    SUPPORT_CONN_DOMAIN_SOUND_AC97 : {
        "version" : 6000,
        "force_version" : True,
        "drv_version" : [ ("qemu", 11000) ],
    },
...
def _check_support(conn, feature, obj=None):
    """
    ...
    @param obj: Option libvirt object to use in feature checking
    @type  obj: Could be virDomain, virNetwork, virStoragePool, etc..
    ...
    if function_name:
        ...
        if args is not None:
            ...
            if object_name:
                ...
                if not isinstance(obj, classobj):
